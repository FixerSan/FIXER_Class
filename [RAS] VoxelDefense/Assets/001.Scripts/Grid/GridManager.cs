...
public class GridManager : MonoBehaviour
{
    ...
    [Header("그리드 사이즈")]
    public int gridHorizontalSize = 10;
    public int gridVerticalSize = 5;

    [Header("그리드 오프셋")]
    public Vector3 gridOffset = new Vector3(0.5f, 0f, 0.5f);
    ...
    public void Awake()
    {
        ...
        //그리드 초기화
        grid = new Grid(gridHorizontalSize, gridVerticalSize);
    }
    ...
    private void EnGridOnScene(int _x, int _y, int _z)
    {
        ...
        if (gridObject != null)
        {
            ...
            Debug.Log($"[{pos.x}, {pos.y}, {pos.z}] 범위에 오브젝트가 그리드에 추가되었습니다.");
        }
    }
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector3 size = new Vector3(gridHorizontalSize, gridVerticalSize, gridHorizontalSize);
        Vector3 center = new Vector3(0, -0.5f, 0) + (size * 0.5f);
...
public class Grid
{
    ...
    public Grid(int _gridHorizontalSize, int _gridVerticalSize)
    {
        gridArray = new GridObject[_gridHorizontalSize, _gridVerticalSize, _gridHorizontalSize];
    }
}
